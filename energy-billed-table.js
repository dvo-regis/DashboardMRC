...
const tableData = [
  ...
  const tbody = document.querySelector("#energyBilledTable tbody");
  ...
  function calculateTotals() {
    ...
    document.getElementById("energyTotalTotal").textContent = totals[0].toFixed(2);
    document.getElementById("energyTotal2023").textContent = totals[1].toFixed(2);
    document.getElementById("energyTotal2022").textContent = totals[2].toFixed(2);
    document.getElementById("energyTotal2021").textContent = totals[3].toFixed(2);
    document.getElementById("energyTotal2020").textContent = totals[4].toFixed(2);
    document.getElementById("energyTotal2019").textContent = totals[5].toFixed(2);
    document.getElementById("energyTotal2018").textContent = totals[6].toFixed(2);
    document.getElementById("energyTotal2017").textContent = totals[7].toFixed(2);
  }
